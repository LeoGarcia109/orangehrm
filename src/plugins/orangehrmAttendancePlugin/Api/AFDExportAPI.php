...
/**
 * REST endpoint for downloading the AFD (Arquivo Fonte de Dados) file.
 *
 * GET /api/v2/attendance/br/afd-export?fromDate=2024-01-01&toDate=2024-01-31&empNumber=1
 *
...
class AFDExportAPI extends Endpoint implements ResourceEndpoint
{
    ...
    public function getOne(): EndpointResult
    {
        ...
        $exporter = new AFDExporter($this->getEntityManager());
        $file = $exporter->generateFile(
            $fromDate,
            $toDate,
            $empNumber > 0 ? $empNumber : null
        );
